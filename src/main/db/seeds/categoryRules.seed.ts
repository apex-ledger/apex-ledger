...
export const CATEGORY_RULES_SEED: CategoryRuleSeedRow[] = [
  ...
  { pattern: 'STAPLES', accountName: 'Office Supplies & Expenses', taxCode: 'HST', priority: 0 },
  { pattern: 'OFFICE DEPOT', accountName: 'Office Supplies & Expenses', taxCode: 'HST', priority: 0 },
