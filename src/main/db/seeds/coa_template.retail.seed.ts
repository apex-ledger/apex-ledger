...
// See coa_template.general_services.seed.ts for the GIFI confidence note — codes here are
// cross-checked against CRA's own published GIFI examples where possible (see gifi_codes.seed.ts).
export const RETAIL_TEMPLATE: CoaTemplate = {
  id: 'retail',
  label: 'Retail',
  description: 'Adds inventory and cost-of-sales accounts on top of the general chart of accounts, for a business that buys and resells goods.',
  accounts: [
    // Assets
    ...
    { code: '1300', name: 'Inventory', accountType: 'Asset', accountSubtype: 'Current Asset', gifiCode: '1120' },
    ...
    { code: '1710', name: 'Furniture, Fixtures & Store Equipment', accountType: 'Asset', accountSubtype: 'Capital Asset', gifiCode: '1787' },
    ...
    // Money received up front from a customer before goods/services are delivered — e.g. a
    // deposit on a special order — stays a liability until earned.
    ...
    // Revenue
    { code: '4000', name: 'Sales Revenue', accountType: 'Revenue', accountSubtype: 'Revenue', gifiCode: '8000' },
    { code: '4100', name: 'Sales Returns & Allowances', accountType: 'Revenue', accountSubtype: 'Revenue', gifiCode: '8000' },
    ...
    // book value — a normal, occasional event (trading in a delivery vehicle, selling old store
    // fixtures), not an operating source of income.
    ...
    // Cost of Sales
    { code: '5000', name: 'Purchases', accountType: 'Expense', accountSubtype: 'Cost of Sales', gifiCode: '8320' },
    { code: '5010', name: 'Freight & Duty on Purchases', accountType: 'Expense', accountSubtype: 'Cost of Sales', gifiCode: '8320' },
    // A refund received back IN from a vendor/vendor (overpayment, duplicate charge, price
    ...
    { code: '6010', name: 'Bank Charges', accountType: 'Expense', accountSubtype: 'Operating Expense', gifiCode: '8710' },
    { code: '6015', name: 'Merchant / Credit Card Processing Fees', accountType: 'Expense', accountSubtype: 'Operating Expense', gifiCode: '8710' },
    { code: '6020', name: 'Insurance', accountType: 'Expense', accountSubtype: 'Operating Expense', gifiCode: '8690' },
    { code: '6030', name: 'Interest & Bank Charges - Long-Term Debt', accountType: 'Expense', accountSubtype: 'Operating Expense', gifiCode: '8710' },
    { code: '6040', name: 'Office Supplies', accountType: 'Expense', accountSubtype: 'Operating Expense', gifiCode: '8810' },
    { code: '6041', name: 'Office Expenses', accountType: 'Expense', accountSubtype: 'Operating Expense', gifiCode: '8810' },
    { code: '6045', name: 'Software & Subscriptions', accountType: 'Expense', accountSubtype: 'Operating Expense', gifiCode: '8810' },
    { code: '6050', name: 'Legal & Accounting Fees', accountType: 'Expense', accountSubtype: 'Operating Expense', gifiCode: '8860' },
    { code: '6060', name: 'Meals & Entertainment', accountType: 'Expense', accountSubtype: 'Operating Expense', gifiCode: '8523' },
    { code: '6070', name: 'Amortization Expense', accountType: 'Expense', accountSubtype: 'Operating Expense', gifiCode: '8670' },
    { code: '6080', name: 'Rent / Lease', accountType: 'Expense', accountSubtype: 'Operating Expense', gifiCode: '8910' },
    { code: '6085', name: 'Property Tax', accountType: 'Expense', accountSubtype: 'Operating Expense', gifiCode: '9180' },
    { code: '6090', name: 'Repairs & Maintenance', accountType: 'Expense', accountSubtype: 'Operating Expense', gifiCode: '8960' },
    { code: '6100', name: 'Salaries, Wages & Benefits', accountType: 'Expense', accountSubtype: 'Operating Expense', gifiCode: '9060' },
    ...
    { code: '6105', name: 'Employee Benefits', accountType: 'Expense', accountSubtype: 'Operating Expense', gifiCode: '8620' },
    // Commission paid out to sales staff on the floor — separate from a bonus or base wage above.
    { code: '6107', name: 'Sales Commissions Paid', accountType: 'Expense', accountSubtype: 'Operating Expense', gifiCode: '9061' },
    { code: '6110', name: 'Motor Vehicle Expenses', accountType: 'Expense', accountSubtype: 'Operating Expense', gifiCode: '9281' },
    { code: '6115', name: 'Vehicle Lease', accountType: 'Expense', accountSubtype: 'Operating Expense', gifiCode: '8915' },
    { code: '6120', name: 'Telephone', accountType: 'Expense', accountSubtype: 'Operating Expense', gifiCode: '9225' },
    ...
    { code: '6121', name: 'Internet', accountType: 'Expense', accountSubtype: 'Operating Expense', gifiCode: '9152' },
    { code: '6125', name: 'Utilities', accountType: 'Expense', accountSubtype: 'Operating Expense', gifiCode: '9220' },
    { code: '6130', name: 'Dues & Subscriptions', accountType: 'Expense', accountSubtype: 'Operating Expense', gifiCode: '8761' },
    { code: '6140', name: 'Training & Education', accountType: 'Expense', accountSubtype: 'Operating Expense', gifiCode: '8876' },
    { code: '6150', name: 'Charitable Donations', accountType: 'Expense', accountSubtype: 'Operating Expense', gifiCode: '8522' },
    ...
    { code: '6170', name: 'Licenses & Permits', accountType: 'Expense', accountSubtype: 'Operating Expense', gifiCode: '8764' },
    ...
    { code: '6180', name: 'Bad Debt Expense', accountType: 'Expense', accountSubtype: 'Operating Expense', gifiCode: '8590' },
    { code: '6190', name: 'Postage & Delivery', accountType: 'Expense', accountSubtype: 'Operating Expense', gifiCode: '9275' },
    { code: '6200', name: 'Storage', accountType: 'Expense', accountSubtype: 'Operating Expense', gifiCode: '8917' },
    { code: '6210', name: 'Security', accountType: 'Expense', accountSubtype: 'Operating Expense', gifiCode: '9013' },
    { code: '6220', name: 'Waste Removal', accountType: 'Expense', accountSubtype: 'Operating Expense', gifiCode: '9014' },
    ...
    { code: '6230', name: 'Selling Expenses', accountType: 'Expense', accountSubtype: 'Operating Expense', gifiCode: '9273' },
    { code: '6240', name: 'Research & Development', accountType: 'Expense', accountSubtype: 'Operating Expense', gifiCode: '9282' },
    ...
    { code: '6250', name: 'General & Administrative Expenses', accountType: 'Expense', accountSubtype: 'Operating Expense', gifiCode: '9284' },
    // Till/cash register discrepancies at end of day — a small, normal cost of handling cash at a
    // retail counter, genuinely distinct from Bank Charges above (a bank/processor-imposed fee).
    { code: '6260', name: 'Cash Over/Short', accountType: 'Expense', accountSubtype: 'Operating Expense', gifiCode: '9271' },
    { code: '6900', name: 'Other Operating Expenses', accountType: 'Expense', accountSubtype: 'Operating Expense', gifiCode: '9270' },
  ],
};
